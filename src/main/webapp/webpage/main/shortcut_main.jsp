...
<t:base type="jquery,ligerui,tools,DatePicker,autocomplete"></t:base>
...
<SCRIPT type="text/javascript">
	...
	$(function() {
		$('#layout_jweb_onlineDatagrid').datagrid({
			...
			onLoadSuccess : function(data) {
				$('#layout_jweb_onlinePanel').panel('setTitle', '( ' + data.total + ' )人在线');
			}
		...
		$('#layout_jweb_onlinePanel').panel({
			tools : [ {
				iconCls : 'icon-reload',
				handler : function() {
					$('#layout_jweb_onlineDatagrid').datagrid('load', {});
				}
			} ]
		});
		...
		$(".layout-expand").click(function(){
			...
			$("#layout_jweb_onlinePanel").find(".datagrid-view").css("max-height","200px");
			$("#layout_jweb_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body").css("max-height","180px").css("overflow-y","auto");
		});
...
<!-- 左侧-->
<div region="west" hide="true" split="true" href="loginController.do?shortcut_top" title="导航菜单" style="width: 170px;" id="west"></div>
<!-- 中间-->
...
<div id="layout_jweb_onlinePanel" data-options="fit:true,border:false" title="用户在线列表">
<table id="layout_jweb_onlineDatagrid"></table>
</div>
</div>
<!-- 底部 -->
