...
<form id="inputFrom" method="post" data-validator-option="{theme:'yellow_right_effect',stopOnError:true,timely:2}" >
	<input type="hidden" name="oldName" value="${sysRole.roleName}"/>
	<input type="hidden" name="id" value="${sysRole.id}"/>
      <div class="open">
      	<div class="dilog"><a href="javascript:;" class="submit-btn"></a></div>
        <div class="dd"><label>角色名称</label><input type="text" name="roleName" maxlength="50" class="in" value="${sysRole.roleName}" data-rule="required;zh_cn;remote[sysRoleController.do?checkSysRole, oldName]" data-rule-zh_cn="[/^[\u4E00-\uFA29]*$/,'请输入中文']" data-ok=""  placeholder="角色名称"/></div>
